"""Tests for cloneCollectionAsCapped writeConcern other field validation."""
...
def test_clone_collection_as_capped_wc_other_fields(database_client, collection, test):
    """Test cloneCollectionAsCapped writeConcern other field validation."""
