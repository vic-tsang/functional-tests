"""Tests for cloneCollectionAsCapped writeConcern top-level validation."""
...
def test_clone_collection_as_capped_wc_toplevel(database_client, collection, test):
    """Test cloneCollectionAsCapped writeConcern top-level validation."""
