"""Tests for cloneCollectionAsCapped writeConcern w field validation."""
...
def test_clone_collection_as_capped_wc_w(database_client, collection, test):
    """Test cloneCollectionAsCapped writeConcern w field validation."""
