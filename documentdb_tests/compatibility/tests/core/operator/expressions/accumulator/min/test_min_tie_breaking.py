...
MIN_TIE_BREAKING_TESTS: list[ExpressionTestCase] = [
    ...
    ExpressionTestCase(
        ...
        doc={"a": 5, "b": Int64(5)},
        expected=["int", 5],
        msg="$min should preserve int32 type when int32 and int64 are equal and int32 is first",
    ),
    ExpressionTestCase(
        ...
        msg="$min should preserve int64 type when int64 and int32 are equal and int64 is first",
    ),
    ExpressionTestCase(
        ...
        doc={"a": 5, "b": 5.0},
        expected=["int", 5],
        msg="$min should preserve int32 type when int32 and double are equal and int32 is first",
    ),
    ExpressionTestCase(
        ...
        doc={"a": 5.0, "b": 5},
        expected=["double", 5.0],
        msg="$min should preserve double type when double and int32 are equal and double is first",
    ),
    ExpressionTestCase(
        ...
        expected=["int", 5],
        msg="$min should preserve int32 when int32 and Decimal128 are equal",
    ),
    ExpressionTestCase(
        ...
        msg="$min should preserve Decimal128 when Decimal128 and int32 are equal",
    ),
    ExpressionTestCase(
        ...
        doc={"a": Int64(5), "b": 5.0},
        expected=["long", Int64(5)],
        msg="$min should preserve int64 type when int64 and double are equal and int64 is first",
    ),
    ExpressionTestCase(
        ...
        doc={"a": 5.0, "b": Int64(5)},
        expected=["double", 5.0],
        msg="$min should preserve double type when double and int64 are equal and double is first",
    ),
    ExpressionTestCase(
        ...
        expected=["long", Int64(5)],
        msg="$min should preserve int64 when int64 and Decimal128 are equal",
    ),
    ExpressionTestCase(
        ...
        expected=["decimal", Decimal128("5")],
        msg="$min should preserve Decimal128 when Decimal128 and int64 are equal",
    ),
    ...
    ExpressionTestCase(
        ...
        expected=["double", 3.5],
        msg=(
            "$min should preserve double when double and Decimal128"
    ...
    ExpressionTestCase(
        ...
        msg=(
            "$min should preserve Decimal128 when Decimal128 and double"
    ...
    ExpressionTestCase(
        ...
        msg="$min should return double -0 when it appears first and +0 is second",
    ),
    ExpressionTestCase(
    ...
    ExpressionTestCase(
        ...
        msg="$min should return Decimal128 -0 when it appears first and +0 is second",
    ),
    ExpressionTestCase(
    ...
    ExpressionTestCase(
        ...
        msg="$min should preserve double Infinity when it appears first",
    ),
    ExpressionTestCase(
        ...
        msg="$min should preserve Decimal128 Infinity when it appears first",
    ),
    ExpressionTestCase(
...
@pytest.mark.parametrize("test_case", pytest_params(MIN_TIE_BREAKING_TESTS))
def test_min_tie_breaking_cases(collection, test_case: ExpressionTestCase):
    """Test $min tie-breaking cases."""
