...
JSONSCHEMA_PARAMS = [
    ...
    BsonTypeTestCase(
        ...
        keyword="properties",
        valid_types=[BsonType.OBJECT, BsonType.EMPTY_OBJECT],
        valid_inputs={BsonType.OBJECT: {"x": {}}, BsonType.EMPTY_OBJECT: {}},
    ),
    BsonTypeTestCase(
        id="additionalProperties",
        msg="additionalProperties should reject non-bool/object types",
        keyword="additionalProperties",
        valid_types=[BsonType.BOOL, BsonType.OBJECT, BsonType.EMPTY_OBJECT],
    ...
    BsonTypeTestCase(
        ...
        keyword="items",
        valid_types=[BsonType.OBJECT, BsonType.ARRAY, BsonType.EMPTY_ARRAY, BsonType.EMPTY_OBJECT],
